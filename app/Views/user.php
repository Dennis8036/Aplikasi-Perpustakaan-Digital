...
<button class="btn btn-primary ti-pencil" 
        ...
        data-namalengkap="<?= $wkwk->namalengkap ?>"
                ...
                <div class="modal-body">
                    <form id="editUserForm" action="<?= base_url('Home/aksi_e_user') ?>" method="POST">
                        <input type="hidden" value="" id="id_user" name="id_user"> <!-- ID ini akan diisi oleh JavaScript -->
                                                <div class="mb-3">
                            <label for="edit_namalengkap" class="form-label">Nama Lengkap</label>
                            <input type="text" class="form-control" value="" id="edit_namalengkap" name="namalengkap" required>
                        </div>
                        <div class="mb-3">
...
<script>
    $(document).ready(function() {
        ...
        $('#editUserModal').on('show.bs.modal', function (event) {
            ...
            modal.find('#edit_namalengkap').val(namalengkap);
