  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <img src="<?= base_url('images/img/' . $setting->logo_dashboard) ?>"  class="logo-dashboard" width="60px">
...
<?php if(session()->get('id_level') == 1 || session()->get('id_level') == 2) { ?>
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('Home/kategori')?>">
...
<?php } ?>
            ...
            <a class="nav-link" href="<?= base_url('Home/peminjaman')?>">
              ...
              <span class="menu-title">Peminjaman</span>
                              ...
                              <li class="nav-item">
            <a class="nav-link" href="<?= base_url('Home/koleksi')?>">
              <i class="ti-heart menu-icon"></i>
              <span class="menu-title">Koleksi Pribadi</span>
            </a>
          </li>

                              <li class="nav-item">
            <a class="nav-link" href="<?= base_url('Home/ulasan')?>">
