                            ...
                            <h4 class="card-title"></h4>
                                ...
                                <form action="<?= base_url('Home/aksi_t_user')?>" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" placeholder="Nama Lengkap" name='nl'>
                                        </div>
                                     </div>
...
<div class="form-group row">
  ...
  <div class="col-sm-10">
    <input type="password" class="form-control" placeholder="Password (min. 8 karakter)" name="password" minlength="8" required>
  </div>
</div>
