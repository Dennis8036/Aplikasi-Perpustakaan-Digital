            ...
            <div class="auth-form-transparent text-left p-3">
              <div class="brand-logo">
                <?php if (!empty($setting->logo_login)): ?>
                  <img src="<?= base_url('images/img/' . $setting->logo_login) ?>" alt="Login Icon" class="img-fluid mb-3 logo-login" style="max-width: 90px;">
                <?php endif; ?>
              </div>
              <h4>New here?</h4>
              ...
              <form action="<?= base_url('Home/aksi_register') ?>" method="POST" class="pt-3">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control form-control-lg border-left-0" name="nl" placeholder="Nama Lengkap" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control form-control-lg border-left-0" name="alamat" placeholder="Alamat" required>
                  </div>
                </div>
